...
res.status(200).json({message:"Your email has been sent successfully to the designated receiving email address. The work of Mark Ezeh!",msg:"Bravo! Email sent successfully"});
